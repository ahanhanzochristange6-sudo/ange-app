...
class RecentScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('RÉCEMMENT')),
      body: prov.recents.isEmpty
          ? _empty()
          : ListView.builder(
              padding: const EdgeInsets.fromLTRB(16, 12, 16, 120),
              itemCount: prov.recents.length,
              itemBuilder: (ctx, i) {
    ...
    return const Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          Text('Aucun historique', style: TextStyle(color: AppTheme.textSecondary)),
        ],
      ),
    );
  }
